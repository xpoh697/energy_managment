        ...
        try:
            ...
            if b_cap > 0.1:
                if mode == "buy":
                    ...
                    _prof_debug = f"Keys:{len(avg_prof_cons or {})} Sum:{sum(float(normalize_float(v)) for v in (avg_prof_cons or {}).values()):.1f} Occ:{occ_coeff:.2f} SurpDC:{early_surplus_dc:.1f}"
